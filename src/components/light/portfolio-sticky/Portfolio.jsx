        ...
        <div className="row">
          <div className="col-lg-8 items">
            <div className="img-container">
              <img className="scroll-img" src="/light/assets/imgs/works/1/mainempowercare.jpg" alt="Empower Care" />
            </div>
          </div>
          <div className="col-lg-4 items">
            <div className="cont">
              <div className="sticky-item">
                ...
                <p>Empowering You to Find Fulfilling Contract and Per Diem Opportunities​.</p>
          ...
          <div className="col-lg-4 items">
            <div className="cont">
              <div className="sticky-item">
                ...
                <p>Enhancing your Business. Simplifying your Focus.</p>
          ...
          <div className="col-lg-8 items">
            <div className="img-container">
              <img className="scroll-img" src="/light/assets/imgs/works/1/westackmain.jpg" alt="WeStack" />
            </div>
          </div>
          <div className="col-lg-8 items">
            <div className="img-container">
              <img className="scroll-img" src="/light/assets/imgs/works/1/unitedestatesmain.jpg" alt="United Estates" />
            </div>
          </div>
          <div className="col-lg-4 items">
            <div className="cont">
              <div className="sticky-item">
                ...
                <p>We have made our quality development a hallmark by incorporating the latest in contemporary architecture to suit your tastes and budget.</p>
          ...
          <div className="col-lg-4 items">
            <div className="cont">
              <div className="sticky-item">
                ...
                <p>Embrace Your Natural Glow with Bare Beauty.</p>
          ...
          <div className="col-lg-8 items">
            <div className="img-container">
              <img className="scroll-img" src="/light/assets/imgs/works/1/barebeautymain.jpg" alt="Bare Beauty" />
            </div>
          </div>
        </div>
      </div>
